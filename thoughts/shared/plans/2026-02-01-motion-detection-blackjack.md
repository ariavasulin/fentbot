...
- [x] Import works: `python -c "from poker.vision import verify_chip_placement, ChipVerification"`
...
#### Automated Verification:
- [x] Import works: `python -c "from poker.robot_interface import robot_started, robot_done, is_robot_executing"`
...
#### Automated Verification:
- [x] No syntax errors: `python -m py_compile poker/main.py`
- [x] Import works: `python -c "from poker.main import run"`
